...
using System.Reflection;
 ...
 public class GizmoOnOff{
    [MenuItem("Gizmos/Disable All Gizmos")]
    static void DisableAllGizmosMenu(){
        ...
        foreach (var a in annotations){
            ...
            SetGizmoEnabled.Invoke(null, new object[] {
				classId, scriptClass, 0
				}
			);
            SetIconEnabled.Invoke(null, new object[] {
				classId, scriptClass, 0
				}
			);
        }
	...
	[MenuItem("Gizmos/Enable All Gizmos")]
